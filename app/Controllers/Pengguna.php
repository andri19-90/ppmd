...
class Pengguna extends BaseController {
    ...
    public function ajaxlist() {
        if(session()->get("logged_in")){
            $data = array();
            $list = $this->model->getAllQ("select *, b.nama_korps, c.nama_pangkat from users a, korps b, pangkat c where a.idrole = 'R00002' and a.idkorps = b.idkorps and a.idpangkat = c.idpangkat;");
