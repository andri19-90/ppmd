                        ...
                        <div class="col-md-4 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer news-letter">
                                ...
                                <div class="social pull-right"> 
                                    <ul>
                                        <li><a class="wow fadeInUp animated" href="<?php echo $tw; ?>"><i class="fa fa-twitter"></i></a></li>
                                        <li><a class="wow fadeInUp animated" href="<?php echo $fb; ?>" data-wow-delay="0.2s"><i class="fa fa-facebook"></i></a></li>
                                        <li><a class="wow fadeInUp animated" href="<?php echo $gp; ?>" data-wow-delay="0.3s"><i class="fa fa-google-plus"></i></a></li>
                                        <li><a class="wow fadeInUp animated" href="<?php echo $ig; ?>" data-wow-delay="0.4s"><i class="fa fa-instagram"></i></a></li>
                                        <li><a class="wow fadeInUp animated" href="<?php echo $lk; ?>" data-wow-delay="0.6s"><i class="fa fa-linkedin"></i></a></li>
                                    </ul> 
                                </div>
                            </div>
                        </div>
