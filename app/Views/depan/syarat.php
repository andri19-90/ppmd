            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    ...
                    <ul class="main-nav nav navbar-nav navbar-right">
                        <li class="wow fadeInDown" data-wow-delay="0.1s"><a href="<?php echo base_url(); ?>/home">Home</a></li>
                        <li class="wow fadeInDown" data-wow-delay="0.1s"><a href="<?php echo base_url(); ?>/produk">Produk</a></li>
                        <li class="wow fadeInDown" data-wow-delay="0.1s"><a class="active" href="<?php echo base_url(); ?>/syarat">Syarat</a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">Syarat Perumahan</h1>               
                    </div>
                </div>
            </div>
        </div>
